		...
		<div id="list-userType" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="title" title="${message(code: 'userType.title.label', default: 'Title')}" />
				...
				<g:each in="${userTypeInstanceList}" status="i" var="userTypeInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${userTypeInstance.id}">${fieldValue(bean: userTypeInstance, field: "title")}</g:link></td>
