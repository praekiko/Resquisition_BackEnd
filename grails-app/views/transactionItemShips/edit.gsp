...
<html>
	...
	<body>
		%{-- <a href="#edit-transactionItemShips" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-transactionItemShips" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:transactionItemShipsInstance, action:'update']" method="PUT" >
