...
<div class="fieldcontain form-group ${hasErrors(bean: itemInstance, field: 'barcode', 'error')} required">
...
<div class="fieldcontain form-group ${hasErrors(bean: itemInstance, field: 'title', 'error')} required">
...
<div class="fieldcontain form-group ${hasErrors(bean: itemInstance, field: 'unit', 'error')} required">
	<label for="unit" class="col-lg-2 control-label">
...
<div class="fieldcontain form-group ${hasErrors(bean: itemInstance, field: 'remaining', 'error')} required">
	<label for="remaining" class="col-lg-2 control-label">
...
<div class="fieldcontain form-group ${hasErrors(bean: itemInstance, field: 'description', 'error')} required">
...
<div class="fieldcontain form-group ${hasErrors(bean: itemInstance, field: 'transactionItemShips', 'error')} ">
