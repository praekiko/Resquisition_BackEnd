			...
			<ol class="property-list user">
				...
				<li class="fieldcontain">
					<span id="type-label" class="property-label"><g:message code="user.type.label" default="Type" /></span>
						...
						<span class="property-value" aria-labelledby="type-label"><g:link controller="userType" action="show" id="${userInstance?.type?.id}">${userInstance?.type?.encodeAsHTML()}</g:link></span>
				...
				<li class="fieldcontain">
					<span id="telNum-label" class="property-label"><g:message code="user.telNum.label" default="Tel Num" /></span>
						...
						<span class="property-value" aria-labelledby="telNum-label"><g:fieldValue bean="${userInstance}" field="telNum"/></span>
				...
				<li class="fieldcontain">
					<span id="barcode-label" class="property-label"><g:message code="user.barcode.label" default="Barcode" /></span>
						...
						<span class="property-value" aria-labelledby="barcode-label"><g:fieldValue bean="${userInstance}" field="barcode"/></span>
