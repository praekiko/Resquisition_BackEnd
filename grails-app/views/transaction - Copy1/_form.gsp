...
<div class="fieldcontain ${hasErrors(bean: transactionInstance, field: 'date', 'error')} required">
	...
	%{-- <joda:dateTimePicker name="date" value="${new LocalDateTime()}" noSelection="['':'-Choose-']"/> --}%
...
<div class="fieldcontain ${hasErrors(bean: transactionInstance, field: 'description', 'error')} required">
	...
	<g:textArea name="description" cols="40" rows="5" maxlength="5000" required="" value="${transactionInstance?.description}"/>
